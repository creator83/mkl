...
Sstring fanOffString (10, 110,  colors16bit::BLACK, colors16bit::RED, "ВЫКЛ",&rFont, 0);
Horline fanOnButton (9, 76, colors16bit::GREEN, 90, 35);
Sstring fanOnString (10, 110,  colors16bit::BLACK, colors16bit::GREEN, "ВКЛ ",&rFont, 0);
Horline fanAutoButton (9, 76, colors16bit::YELLOW, 90, 35);
Sstring fanAutoString (10, 110,  colors16bit::BLACK, colors16bit::YELLOW, "АВТО",&rFont, 0);

//floor button
Horline floorOffButton (115, 76, colors16bit::RED, 90, 35);
Sstring floorOffString (120, 110,  colors16bit::BLACK, colors16bit::RED, "ВЫКЛ" ,&rFont, 0);
Horline floorOnButton (115, 76, colors16bit::GREEN, 90, 35);
Sstring floorOnString (120, 110,  colors16bit::BLACK, colors16bit::GREEN, "ВКЛ ",&rFont, 0);
